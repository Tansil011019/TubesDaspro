def tic_tac_toe():
    ...
    while (chance != 0):
        row = int(input("Masukkan baris: "))-1
        col = int(input("Masukkan kolum: "))-1
        if(array[row][col]=="#"):
            if(chance%2 == 0):
                array[row][col]="O"
            else:
            ...
            if(((array[0][1]==array[0][0]==array[0][2])and(array[0][1]!="#" and array[0][0]!="#" and array[0][2]!="#")) or ((array[1][1]==array[1][0]==array[1][2])and(array[1][1]!="#" and array[1][0]!="#" and array[1][2]!="#")) or ((array[2][1]==array[2][0]==array[2][2])and(array[2][1]!="#" and array[2][0]!="#" and array[2][2]!="#"))):
                ...
                chance = 0
            elif(((array[0][0]==array[1][1]==array[2][2])and(array[0][0]!="#" and array[1][1]!="#" and array[2][2]!="#")) or ((array[0][2]==array[1][1]==array[2][1])and(array[0][2]!="#" and array[1][1]!="#" and array[2][1]!="#"))):
